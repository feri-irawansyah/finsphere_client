<script>
    import ModalTenantConfigs from "$lib/components/molecules/modals/ModalTenantConfigs.svelte";
            ...
            <ClientGrid
                ...
                on:doubleClicked={(e) =>
                    modalStore.open(
                        ...
                        "View Tenant Configuration Details",
                        "",
                        {
                            actions: "update",
                            uid: e.detail.tenantConfigurationUid,
                            isFormViewOnly: true,
                        },
                    )}
            />
